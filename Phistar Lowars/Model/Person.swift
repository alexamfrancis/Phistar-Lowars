...
class Person: Codable {
    ...
    func getDetails() -> [String] {
        return ["Height: \(self.height!)", "Mass: \(self.mass!)", "Hair Color: \(self.hairColor!)", "Skin Color: \(self.skinColor!)", "Eye Color: \(self.eyeColor!)", "Birth Year: \(self.birthYear!)", "Gender: \(self.gender!)", "Homeworld: \(NetworkManager.shared.planetURLDictionary[self.homeworld!]!)"] //, "Films: \(self.films!.joined(separator: ", "))", "Species: \(self.species!.joined(separator: ", "))", "Vehicles: \(self.vehicles!.joined(separator: ", "))", "Starships: \(self.starships!.joined(separator: ", "))"]
    }
